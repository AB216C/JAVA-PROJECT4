...
public class JDBCTest {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        try {
            ...
            getAllStudents().forEach(s -> System.out.println(s.getId() + "." + s.getName() +"," + s.getEmail()+"-"+ s.getGrade()));
            // Get student by ID
            System.out.println("\nStudent with ID 2:");
            Student student = getStudentById(2);
            if (student != null)
                System.out.println(student.getId() + "." + student.getName() + "," + student.getEmail()+ "-"+ student.getGrade());
            // Update student
            ...
            System.out.println("Updated Student: " + updated.getId() + "." + updated.getName() + "," + updated.getEmail()+"-"+ updated.getGrade());
            // Delete student
            System.out.println("\nDeleting student with ID 3...");
            deleteStudent(3);
            // Final result after deleting a certain id(student)
            ...
            createTable(); //RecreatING empty table
